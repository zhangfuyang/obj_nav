...
def get_args():
    ...
    parser.add_argument('--agent_type', type=str, default="model",
                        help='model, random, gt (shortest path)')
    ...
    parser.add_argument('--num_training_frames', type=int, default=1000000000,
    ...
    parser.add_argument('--save_interval', type=int, default=1,
                        help="""save interval""")
    parser.add_argument('-d', '--dump_location', type=str, default="./tmp_final_v3/",
    ...
    parser.add_argument('-efw', '--frame_width', type=int, default=640,
                        help='Frame width (default:640)')
    parser.add_argument('-efh', '--frame_height', type=int, default=480,
    ...
    parser.add_argument('--num_sem_categories', type=float, default=0)
