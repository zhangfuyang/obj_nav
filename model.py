...
from constants import coco_categories, mp3d_region_id2name
...
class Semantic_Mapping(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.num_sem_categories = len(coco_categories) + len(mp3d_region_id2name) # object semantic & region semantic
    ...
    def forward(self, obs, maps_last, poses):
        ...
        semantic_length = len(coco_categories) + len(mp3d_region_id2name)
        agent_view[:, 4:4+semantic_length, y1:y2, x1:x2] = torch.clamp(
